...
const ServiceDetails = () => {
  ...
  useEffect(() => {
    fetch('/petServices.json') // MUST be inside public/
      .then(r => r.json())
      .then(data => {
        const found = data.find(d => Number(d.serviceId) === Number(serviceId)); // FIXED
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="space-y-2">
        ...
        <p><strong>Email:</strong> <a href={`mailto:${service.providerEmail}`} className="text-blue-500">{service.providerEmail}</a></p>
